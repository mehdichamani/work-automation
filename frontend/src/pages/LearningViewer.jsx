  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800">📚 آموزش</h1>
        {user?.role === 'admin' && (
          <button
      ...
      <div className="flex flex-wrap gap-4 items-center">
        <input
          ...
          className="px-4 py-2 border rounded-xl flex-1 min-w-[200px] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
        />
        <select
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredMaterials.map((material) => (
            ...
            >
              <div className="h-40 bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center text-6xl">
      ...
      {viewingMaterial && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={handleCloseViewer}>
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between p-4 border-b">
              <h2 className="font-bold text-lg text-gray-800">{viewingMaterial.title}</h2>
              <button onClick={handleCloseViewer} className="text-gray-400 hover:text-gray-600 text-2xl leading-none">&times;</button>
            </div>
